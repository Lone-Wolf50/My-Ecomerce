...
function Footer() {
  // Track which info dropdown is active
  ...
  const handleInteraction = (name) => {
    // Toggle for mobile/click, hover is handled by mouse events
  ...
  return (
    <footer className="relative w-full mt-24 overflow-hidden">
      ...
      <div className="w-full bg-white/10 backdrop-blur-[60px] backdrop-saturate-150 border-t border-white/30 py-16">
