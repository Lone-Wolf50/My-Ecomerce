      ...
      >
        <div className="max-w-[1440px] mx-auto h-full px-5 md:px-10 lg:px-16 flex items-center">
          ...
          <div className="flex items-center gap-3 ml-auto">
            ...
            {/* Inbox icon — mobile top bar (with unread badge) */}
            {isLoggedIn && (
              <Link
                to="/inbox"
            ...
            {isLoggedIn && (
              ...
              >
                <span className="material-symbols-outlined text-[15px] text-white" style={{ fontVariationSettings: "'FILL' 0, 'wght' 400" }}>shopping_cart</span>
            ...
            {isLoggedIn ? (
              <div className="hidden md:flex items-center gap-2">
                ...
                {/* User dropdown — fixed hover on desktop */}
                <div className="relative">
                  ...
                  {/* Dropdown — uses focus-within + peer so it stays open while hovering the menu itself */}
